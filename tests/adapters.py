...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.models import run_scaled_dot_product_attention
...
def run_rope(
    ...
    """
    from cs336_basics.models import RoPEModel
    rope = RoPEModel(theta, d_k, max_seq_len)
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.models import run_SiLU
    return run_SiLU(in_features)
...
def run_get_batch(
    ...
    return run_get_batch(dataset, batch_size, context_length, device)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.nn_utils import run_softmax
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.nn_utils import run_cross_entropy
    return run_cross_entropy(inputs, targets)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    from cs336_basics.bpe_tokenizer import train_BPETokenizer
    return train_BPETokenizer(input_path, vocab_size, special_tokens)
    raise NotImplementedError
